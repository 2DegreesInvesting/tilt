...
With few exceptions, each repository is structured
as an R package. [*Every package must have a
DESCRIPTION. In fact, it's the defining feature of a
...
the app, and moving towards the deeper layers of the tilt system architecture:
...
other "tilt" packages. To discover each dependency see the `Remotes`
section of its DESCRIPTION file.
...
site to GitHub Pages ([video](FIXME)).
